...
const getLanguageService = (filePaths, host, options = {}) => {
    ...
    const servicesHost = {
        ...
        readFile: (path, encoding) => host.read(path).toString(encoding)
    };
...
const getTypeDefinitionAtPosition = (langServ, entryPath, position) => {
    ...
    let definition;
    try {
        definition = (_a = langServ.getDefinitionAndBoundSpan(entryPath, position)) === null || _a === void 0 ? void 0 : _a.definitions[0];
    }
    catch (err) {
        return null;
    }
    ...
    if (!typeDefs) {
        ...
        */
        ...
        const member = classDeclaration.members
            .filter(x => x.kind !== ts.SyntaxKind.Constructor)
            .find(m => { var _a; return ((_a = m.name) === null || _a === void 0 ? void 0 : _a.getText()) === definition.name; });
        if (!member) {
            return null;
        }
...
const isMemberIgniteUI = (change, langServ, entryPath, matchPosition) => {
    ...
    let typeDef;
    try {
        typeDef = (0, exports.getTypeDefinitionAtPosition)(langServ, entryPath, matchPosition);
    }
    catch (err) {
        false;
    }
