...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.8", ngImport: i0, type: IgxSwitchComponent, decorators: [{
            type: Component,
            args: [{ providers: [{
                            provide: EDITOR_PROVIDER,
                            useExisting: IgxSwitchComponent,
